...
namespace ZXing.Net.Mobile.Forms
{
    public class ZXingScannerView : View
    {
        ...
        public EventHandler<byte[]> OnTakePicture;
        ...
        public static readonly BindableProperty TakePictureProperty =
            BindableProperty.Create(nameof(TakePicture), typeof(bool), typeof(ZXingScannerView), false);

        public bool TakePicture
        {
            get { return (bool)GetValue(TakePictureProperty); }
            set { SetValue(TakePictureProperty, value); }
        }
